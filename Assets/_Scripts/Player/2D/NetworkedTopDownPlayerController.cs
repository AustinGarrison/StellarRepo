...
{
    public class NetworkedTopDownPlayerController : NetworkBehaviour, ICharacterController
    {
        ...
        public override void OnStartClient()
        {
            ...
            {
                gameObject.GetComponent<NetworkedTopDownPlayerController>().enabled = false;
            }
        }
